...
## remove old build and publish
rm -rf app-build
rm -rf app-publish

## build and publish
dotnet build bz1-rinha-de-backend-2025.csproj -c Release -o app-build
dotnet publish bz1-rinha-de-backend-2025.csproj -c Release -o app-publish
...
podman image inspect rafaelberrocalj/bz1:rinha-de-backend-2025-latest | grep -i architecture
